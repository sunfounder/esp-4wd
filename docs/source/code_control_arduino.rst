...
Arduino\example, you can see a total of 7 code examples, you can use these 7
...
Open the 1.move.ino file with arduino, After running this example, the car will go
